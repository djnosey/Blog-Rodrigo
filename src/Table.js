    ...
    <div className="table">
      <table width="100%" cellspacing="0" cellpadding="0">
        <caption className="table__caption">
          <h4>
            RANKING BROADCAST PROJEÇÕES: GO ASSOCIADOS CONQUISTA PRIMEIRO LUGAR
            NO TOP BÁSICO DO 2º TRI
          </h4>
        ...
        <tr>
          ...
          <td>
            <strong>Aviso em Dois Consultoria</strong>
          </td>
        </tr>
        <tr>
          <td>
